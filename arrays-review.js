...
// let fiveNums = ["2","3","4","5","7"];

// let secondValue = fiveNums[1];

// // console.log(fiveNums.slice(1,2));
// console.log(fiveNums[2]);

// fiveNums[3] = "0";

// lastVal = fiveNums.splice(4);

// console.log(lastVal)

// console.log(fiveNums.push("524"));

// fiveNums.push("76");

// console.log(fiveNums);

// console.log(fiveNums[4]);

// console.log(fiveNums[fiveNums.length + 4]);
// console.log(array.find(fiveNums("524")))
...
// let fiveItems = ["talon","katarina","akali","zed","yasuo"]

// while(zeroVar != fiveItems.length){
// 	zeroVar++;
// 	console.log(fiveItems[1,3]);
// }
...
// let empty = ["", ""];
// 	console.log(empty.push("katarina"));
// 	console.log(empty.push("NF"));
// 	console.log(empty.push("Logic"));
// 	console.log(empty.push("Witt Lowry"));
...
// let currentFood;
// let foods = [ "pasta", "pork chops", "ziti", "bacon" ];
