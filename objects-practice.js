...
let myObjKeys = [Obj.keys()];
console.log(myObjKeys);

let myObjValues = [Object.values()];
...
var names = {
	...
	delete names.Logic;
	names.Eminem = "The bomb";
	names.Logic = "In my top 3";
	console.log(names());
	// var myVal = 
	// console.log
...
let string  = ["table", "chair"]
let obj = {italian: spaghetti}
